...
description: Designing new sections, choosing visuals, typography, palette decisions
model: inherit
tools: Read, Write, Edit, Bash, WebFetch, WebSearch, Skill, mcp__puppeteer__puppeteer_screenshot
---
...
- **Structure:** single-page with 6 `<section>` blocks (Header → Hero → Skills → Experience → Projects → Contact)
- **Signature:** orbiting logo ring in hero (8 tech icons, CSS rotate, speeds up on hover)
- **Critical:** Don't remove the logo orbit, don't add npm dependencies without asking, co-locate components in page.tsx
- Read `.claude/skills/frontend-design/SKILL.md` for the full design philosophy
